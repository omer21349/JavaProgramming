...
public class StockMarket {
    public static void main(String[] args) {
        ...
        if(shares>0){
            ...
            String mostShare= input.nextLine();

            System.out.println("Your total stock market holding is $"+value+" which is made up of "+shares+" shares. "+mostShare+" is your company holdings." );
        }
        input.close();
