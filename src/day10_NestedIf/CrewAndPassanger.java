...
public class CrewAndPassanger {
    public static void main(String[] args) {
        ...
        String a=(number==50)? "Total: 50  ====> 20 crew, 30 passengers":(number==75)?"Total: 75  ====> 25 crew, 50 passengers":(number==100)?"Total: 100 ====> 30 crew, 70 passengers":"Any other number of people on the ship is not valid";
